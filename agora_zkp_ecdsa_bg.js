import * as wasm from './agora_zkp_ecdsa_bg.wasm';
...
* @returns {any}
*/
export function generateProof(input, ring) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.generateProof(retptr, addHeapObject(input), addHeapObject(ring));
...
* @returns {any}
*/
export function verifyProof(proof, ring) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.verifyProof(retptr, addHeapObject(proof), addHeapObject(ring));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        var r2 = getInt32Memory0()[retptr / 4 + 2];
        if (r2) {
